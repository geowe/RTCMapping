...
AppContext.prototype.initTools = function() {
  ...
  this.attachTool(new ZoomToExtentTool({id:"zoomToExtentTool", vectorSource: this.vector.getSource()}));
  ...
  this.attachTool(new SelectTool({id:"selectTool", cursor: "alias"})); 
...
AppContext.prototype.initRte = function(){  
  var this_ = this;
  this.rte = new Rte({appContext: this_,
    map: this_.map,
